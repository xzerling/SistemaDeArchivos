 ...
 * @author Yorch
 */
public class FXMLReservarCanchaController implements Initializable
{
    ...
    {
        Sistema.calTarifa();
        this.listaSociosReserva.setItems(Sistema.nombreClientes);
        this.cancha.setText(Sistema.cancha);
        this.fecha.setText(Sistema.dia.getDia()+" "+Sistema.dia.getFecha());
        this.hora.setText(String.valueOf(Sistema.bloque));
        this.tarifa.setText(String.valueOf(Sistema.tarifa));
